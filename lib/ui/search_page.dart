import 'package:flutter/material.dart';import 'package:practical_project/services/web_services.dart';
...
class _SearchPageState extends State<SearchPage> {bool isloading = true;
List posts=[];
@override
void initState() {
  _fetchedData();
